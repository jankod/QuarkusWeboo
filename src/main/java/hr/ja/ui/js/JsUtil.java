...
public class JsUtil {
    ...
    public static String createJsEventsCallCode(List<DualSideEvent> dualSideEvents) {
        StringBuilder js = new StringBuilder();

        for (DualSideEvent e : dualSideEvents) {
            ...
            String template = """
                  ...
                  """;
            js.append(QuteUtil.quteMap(template,
                  Map.of(
                        "widgetId", widgetId,
                        "eventName", eventName,
                        "funcCall", funcCall
    ...
    public static String createJsFunctionDefinitionCode(Class<? extends JavaScriptFunction> c) {
        ...
        String template = """
              ...
              """;
        return QuteUtil.quteMap(template, Map.of("functionName", functionName, "code", code));
    }
