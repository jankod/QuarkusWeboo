...
@Getter
@Setter
public class Navbar extends DefaultWidget {

    private List<NavbarItem> items = new ArrayList<>();

    private NavbarItem homeItem = new NavbarItem("Home", HomePage.URL, Icon.home());
    private NavbarItem usersItem = new NavbarItem("Users", UsersPage.URL, Icon.users());
    private NavbarItem addUsersItem = new NavbarItem("Add User", AddUserPage.URL, Icon.addUsers());
                      ...
                      <div class="nav-item dropdown">
                        <a
                          ...
                          <div class="d-none d-xl-block ps-2">
                            <div>Marko Euro</div>
                            <div class="mt-1 small text-secondary">Design</div>
                          </div>
                        </a>
    ...
    public NavbarItem addItem(NavbarItem item) {
        items.add(item);
        return item;
    }
}
