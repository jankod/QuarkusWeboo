const weboo = {
    ...
    handleEventOnServer(widgetId, eventName, handlerId, result) {
        ...
        $.ajax({
            method: 'POST', url: '/weboo/event', headers: headers, data: result
    ...
    form(formId) {
        $("#" + formId).on('submit', function (event) {
            ...
            $.ajax({
                method: "POST", url: "/weboo/form", // actionUrl,
                data: JSON.stringify(jsonForm), contentType: "application/json", dataType: 'json', headers: headers
            }).done(function (res) {
                ...
                Swal.fire({
                    icon: 'error', title: 'Oops... error', html: err.responseJSON.message
                });
            })
        });
    }
